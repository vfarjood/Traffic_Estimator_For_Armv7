...
int main(int argc, char** argv)
{
  ...
  float trainingData[60][3] = { {25, 120, 8}, {6, 2, 12},  {12, 31, 26}, {21, 105, 2}, {15, 75, 12},{6, 54, 33},
  ...
  cv::Mat trainingDataMat(60, 3, CV_32F, trainingData);
  cv::Mat labelsMat(60, 1, CV_32SC1, labels);
